...
const GAMES = [
  ...
  { slug: "python-quest", name: "Python Quest", desc: "Learn real Python by adventuring through the Code Kingdom!", emoji: "🐍", tracks: ["code_rangers", "cyber_pioneers"], soon: false },
        ...
        {myGames.map(g => {
          ...
          return (
            <div key={g.slug} className="rounded-2xl p-5 bg-white relative overflow-hidden" style={{ boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
              ...
              {!g.soon && !isLocked && (
                <Link
                  to={g.slug === "pixel-pet-coder" ? "/games/pixel-pet-coder" : g.slug === "typing-ninjas" ? "/games/typing-ninjas" : g.slug === "packet-race" ? "/games/packet-race" : g.slug === "math-maze" ? "/games/math-maze" : g.slug === "security-sentinel" ? "/games/security-sentinel" : g.slug === "python-quest" ? "/games/python-quest" : "#"}
                  search={{ childId }}

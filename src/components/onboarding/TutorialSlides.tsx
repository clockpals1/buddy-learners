    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      ...
      >
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <h3 className="text-2xl font-700 mb-3">{slides[currentSlide].title}</h3>
            ...
            {slides.map((_, i) => (
              <div
                ...
                className={`w-2 h-2 rounded-full transition ${
                  i === currentSlide ? "bg-coral w-6" : "bg-gray-300"
                }`}
              />
            ))}
          </div>
        ...
        <div className="flex items-center justify-between p-4 border-t border-border bg-muted">
          ...
          <button
            onClick={nextSlide}
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-cta text-coral-foreground hover:scale-[1.02] transition"
          >
